...
function to_page_saleOrderCheck(pageIndex,checkSaleOrderNumber,checkSaleOrderStateNumber) {
	$.ajax({
		url : "/ordercheck/getsaleorderchecklist",
		dataType : 'json',
		data : {
			pageIndex : pageIndex,
...
$(document).on("click",".sOrderAdoptCheck_btn",function(){
	...
	var saleOrderCheckUrl = "/ordercheck/modifysaleordercheck?sorderId="+sorderId;
	//获取审核状态文字
...
$(document).on("click",".sOrderRevokeCheck_btn",function(){
	...
	var saleOrderRevokeUrl = "/ordercheck/modifysaleorderrevoke?sorderId="+sorderId;
