...
function to_page_purchaseOrderCheck(pageIndex,checkOrderNumber,checkStateNumber) {
	$.ajax({
		url : "/ordercheck/getpurchaseorderchecklist",
		dataType : 'json',
		data : {
			pageIndex : pageIndex,
...
$(document).on("click",".pOrderAdoptCheck_btn",function(){
	...
	var purchaseOrderCheckUrl = "/ordercheck/modifypurchaseordercheck?porderId="+porderId;
	//获取审核状态文字
...
$(document).on("click",".pOrderRevokeCheck_btn",function(){
	...
	var purchaseOrderRevokeUrl = "/ordercheck/modifypurchaseorderrevoke?porderId="+porderId;
