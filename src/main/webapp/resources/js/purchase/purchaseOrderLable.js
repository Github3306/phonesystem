...
function getGoodsInfoToPurchaseSelect() {
	//商品信息
	var goodsUrl = "/admin/getallgoodslist";
	//商品信息放置select中
...
function getSupplierInfoToPurchaseSelect() {
	var supplierUrl = "/purchase/getallsupplierlist";
	//商品信息放置select中
...
function getRepositoryInfoToPurchaseSelect() {
	var repositoryUrl = "/admin/getallrepositorylist";
	//商品信息放置select中
...
$(document).on("click",".delete_pOrder_btn",function(){
	...
	var delPurchaseOrderUrl = "/purchase/removepurchaseorder?porderId="+porderId;
...
$(document).on("click",".edit_pOrder_btn",function(){
	...
	var purchaseOrderInfoUrl = "/purchase/getpurchaseorderbyid?porderId="+porderId;
