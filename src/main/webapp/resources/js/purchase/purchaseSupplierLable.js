...
function to_page_supplier(pageIndex,supplierName) {
	$.ajax({
		url : "/purchase/getpurchasesupplierlist",
		dataType : 'json',
...
$(document).on("click",".delete_supplier_btn",function(){
	...
	var delSupplierUrl = "/purchase/removesupplier?supplierId="+supplierId;
...
$(document).on("click",".edit_supplier_btn",function(){
	...
	var supplierInfoUrl = "/purchase/getsupplierbyid?supplierId="+supplierId;
