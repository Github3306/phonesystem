...
function getRoleInfoToSelect() {
	//员工角色信息
	var EmployeeroleUrl = "/admin/listrole";
	//员工角色信息放置select中
...
function addEmployee() {
	//员工角色信息
	var EmployeeroleUrlDialog = "/admin/listrole";
...
//	var tr = $(this).parent().parent();
	...
	var delEmployeeUrl = "/admin/removeemployee?employeeId="+employeeId;
...
$(document).on("click",".edit_btn",function(){
	...
	var EmployeeInfoUrl = "/admin/getemployeebyid?employeeId="+employeeEditId;
