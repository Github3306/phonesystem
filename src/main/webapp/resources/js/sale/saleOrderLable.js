...
function getCustomerInfoToSelect() {
	var customerUrl = "/sale/getallcustomerlist";
	//商品信息放置select中
...
$(document).on("click",".delete_sOrder_btn",function(){
	...
	var delSaleOrderUrl = "/sale/removesaleorder?sorderId="+sorderId;
...
$(document).on("click",".edit_sOrder_btn",function(){
	...
	var saleOrderInfoUrl = "/sale/getsaleorderbyid?sorderId="+sorderId;
