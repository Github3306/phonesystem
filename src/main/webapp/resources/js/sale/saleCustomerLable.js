...
$(document).on("click",".delete_customer_btn",function(){
	...
	var delCustomerUrl = "/sale/removecustomer?customerId="+customerId;
...
$(document).on("click",".edit_customer_btn",function(){
	...
	var customerInfoUrl = "/sale/getcustomerbyid?customerId="+customerId;
